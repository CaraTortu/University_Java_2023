...
public class ExceptionHandlerTest {
    ...
    public void all() {
        ...
        // Add employees
        persons.add(new Employee("Ms", "Faye", "Mcguire", "087 1234567", new Date(7, 12, 2000), new Date(12, 10, 2020), 24000));
        persons.add(new Employee("Mr", "Ben", "Carson", "086 1234567", new Date(20, 10, 1980), new Date(10, 10, 2012), 42000));
        persons.add(new Employee("Mr", "Mark", "Logan", "087 9876543", new Date(1, 1, 1994), new Date(2, 8, 2018), 28000));
        
        // Add persons 
        persons.add(new Passenger("Mr", "Homer", "Simpson", "087 1234567", "homer.simpson@atu.ie", 0, false, "1111111111111111", new Date(3, 4, 2027), 474));
        persons.add(new Passenger("Mr", "Homer", "Simpson", "087 1234567", "homer.simpson@atu.ie", 0, false, "1111111111111111", new Date(3, 4, 2027), 474));
